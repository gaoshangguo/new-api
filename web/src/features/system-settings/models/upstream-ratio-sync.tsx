...
type UpstreamRatioSyncProps = {
  modelRatios: {
    ...
    'billing_setting.billing_duration_price': string
  }
}
...
function optionKeyBySyncField(ratioType: string): string {
  const explicit: Record<string, string> = {
    ...
    billing_duration_price: 'billing_setting.billing_duration_price',
  }
    ...
    async (currentRatios: ParsedRatios): Promise<boolean> => {
      const finalRatios: Record<string, Record<string, number | string>> = {
        ...
        'billing_setting.billing_duration_price': {
          ...currentRatios['billing_setting.billing_duration_price'],
        },
      }
