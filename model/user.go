...
type User struct {
	...
	CaptchaId        string                     `json:"captcha_id" gorm:"-:all"`                                // this field is only for image captcha verification, don't save it to database!
	CaptchaCode      string                     `json:"captcha_code" gorm:"-:all"`                              // this field is only for image captcha verification, don't save it to database!
